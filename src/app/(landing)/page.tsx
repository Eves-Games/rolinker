      ...
      <section className='bg-gradient-to-r from-red-800 to-[#E12626] py-16 shadow-lg'>
        <div className='container grid grid-cols-1 md:grid-cols-2 gap-16 justify-between items-center max-w-screen-lg'>
          <div className='flex flex-col gap-8 items-center text-center lg:items-start lg:text-left'>
            ...
            <Link className='flex items-center space-x-2 px-4 py-2 border-dashed border-2 rounded w-fit' href='https://discord.com/api/oauth2/authorize?scope=bot+applications.commands&client_id=990855457885278208&permissions=8&redirect_uri=https://rolinker.net/api/auth/guild&response_type=code'>
