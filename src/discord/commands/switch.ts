import { APIChatInputApplicationCommandInteraction, APIInteractionResponse, ComponentType, InteractionResponseType, MessageFlags } from 'discord-api-types/v10';
import { generateMessage, MessageTitles, noLinkedAccounts } from '@/discord/messages';
import db from '@/db';
