...
export async function acceptCommand(interaction: APIChatInputApplicationCommandInteraction) {
    ...
    try {
        ...
        console.log(err)
        return generateMessage({ responseType: InteractionResponseType.ChannelMessageWithSource, title: MessageTitles.UnableAccept, color: MessageColors.Red });
    };
